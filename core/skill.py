...
def buy_skill_end_career():
  info("Memulai pembelian skill untuk akhir karir (skills2_btn).")
  device_action.locate_and_click("assets/buttons/skills2_btn.png", min_search_time=get_secs(2))
  sleep(1)
  shopping_list=[]
  while True:
    screenshot1 = device_action.screenshot(region_ltrb=constants.SCROLLING_SKILL_SCREEN_BBOX)
